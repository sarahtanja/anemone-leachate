...
his code is designed to be run manually, and daily, for each day of acclimation and experimentation that you want Apex data for. The Apex overwrites all data after 24 hours (double check that... I thought it was longer)
...
seatablesurl <- paste0('http://192.168.1.16/cgi-bin/datalog.xml?sdate=',todaysdate,'&days=7')
```
