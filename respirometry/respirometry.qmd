...
This is how Craig did it: using a `for loop` and `pivot wider` to make dataframes for each run
```{r}
...
[calc_rate.bg - calculate background oxygen](https://januarharianto.github.io/respR/articles/closed.html#summary:~:text=calc_rate.bg%20%2D%20calculate%20background%20oxygen)
...
Lets calculate the background for each run in the oxygen consumption portion of the respirometry test
